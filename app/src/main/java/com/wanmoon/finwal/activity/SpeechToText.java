...
public class SpeechToText extends AppCompatActivity implements View.OnClickListener{
    ...
    public void fetchFirebase(){
        ...
        final String[] test = {"ค่าไฟ","ต้มยำ","ค่าเรียน","น้ำ", "ข้าว","นม","ขนม","เนย", "ผลไม้", "ผัดกะเพรา"
                , "ค่ารักษา","ค่ายา","ค่าโรงพยาบาล", "ค่าหมอ"
                ,"หุ้น", "เสื้อผ้า", "ต่างหู", "กำไล", "แหวน", "กางเกง", "เสื้อ", "ชุดชั้นใน"
                , "ชุดนอน", "ค่ารถเมล์", "ค่ารถไฟ", "ค่าเรือ", "ค่าเครื่องบิน", "ค่าแท๊กซี่", "ค่าอูเบ้อ", "ค่าแกร้บ"
                , "เที่ยว", "ค่าทัวร์", "สวนสนุก", "สวนน้ำ", "เก้าอี้," , "โต๊ะ", "ถุงเท้า",     "หมอน" ,      "ต้นไม้",   "กระเบื้อง"
                , "สีทาบ้าน" ,  "หูฟัง",  "ตู้เสื้อผ้า" , "กล่อง"
                ,"ถ่ายเอกสาร" ,"ดินสอ" ,"ยางลบ" ,"ไม้บรรทัด"
                ,"สมุด" ,"รายงาน"
                ,"แม๊ก" ,"ลิควิด"
                ,"ไส้ดินสอ" ,"ปากกา"
                ,"ค่าหนี้นอกระบบ" ,"ค่าผ่อน" ,"ค่าแชร์" ,"ค่าน้ำ" ,"ค่าบ้าน"
                ,"สองแถว" ,"วิน" ,"กระป๊อ" ,"ตุ๊กตุ๊ก"
                ,"ไข่" ,"หมู" ,"ไก่" ,"เนื้อ"
                ,"ปลา" ,"ทอดมัน" ,"ข้าว"
                ,"บิงซู" ,"ทาโร่" ,"โปเต้" ,"ยา"
                ,"คอนแทคเลนส์" ,"วิตามินซี"
                ,"วิตามินอี" ,"วิตามินบี" ,"พารา" ,"กระต่ายบิน"};
