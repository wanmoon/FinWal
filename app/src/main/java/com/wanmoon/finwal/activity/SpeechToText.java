...
public class SpeechToText extends AppCompatActivity implements View.OnClickListener{
    ...
    public void fetchFirebase(){
        ...
        final String[] test = {"กระป๊อ ","กระเบื้อง ","กล่อง ","กางเกง ","กำไล ","ขนม ","ข้าว ","ข้าวผัด ","คอนแทคเลนส์ ","ค่ายา ",         //1
                "ค่ารถเมล์ ","ค่ารักษา"," ค่าหมอ ","ค่าเครื่องบิน ","ค่าเรียน ","ค่าเรียนดนตรี ", "ค่าเรือ ","ค่าโทรศัพท์ ","ค่าโรงพยาบาล ","ค่าไฟ ",   //2
                "ชุดนอน ","ดินสอ ","ดื่ม ","ตู้เสื้อผ้า ","ต่างหู ","ต้นไม้ ","ต้มยำ ","ถุงเท้า ","ถ่ายเอกสาร ","ทอดมัน ",                           //3
                "ทาโร่ ","นม ","บริจาค"," บิงซู ","ปลา ","ปากกา ","ผลไม้ ","ผัดกะเพรา"," พารา ","ยา ",                                   //4
                "ยางลบ ","รองเท้า ","รายงาน ","ลิควิด ","วิตามินซี ","วิตามินบี ","วิตามินอี ","วิน ","สีทาบ้าน"," หนังสือ ",                       //5
                "หมอน ","หมู ","หุ้น ","หูฟัง ","เก้าอี้ ","เนย ","เนื้อ ","เป๊ปซี่ ","เลย์ ","เสื้อผ้า ",                                          //6
                "แม๊ก ","แหวน ","โต๊ะ ","โปเต้ ","ไก่ ","ไข่ ","ไม้บรรทัด ","ไส้ดินสอ ","หนังสือ", "คอมพิวเตอร์",                             //7
                "มือถือ","น้ำ","กระต่ายบิน","ตุ๊กตุ๊ก","ค่าหนี้นอกระบบ","ค่าผ่อน","ค่าทัวร์","ป๊อกกี้","แมนซั่ม","กระเป๋าตังค์",                  //8
                "อิมพีเรียล","จอคอมพิวเตอร์","ธนบัตร","นิชชิน","ออร่า","ยาคูลท์","มินิทเมท","แว่นตา","ตัดผม", "ชาเย็น",                  //9
                "โกโก้","ลาเต้","อเมริกาโน่","ชามะนาว","ไก่ทอด","สเวนเซ่น","แซลม่อน","เนื้อจระเข้","มอคค่า","กระดาษ"};  //10 per line : 100
