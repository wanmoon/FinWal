...
$sql = "SELECT timestamp, description, cost, transaction, category FROM transaction WHERE transaction='Expense' AND MONTH(CURDATE())=MONTH(timestamp) AND cust_id='$cust_id' ORDER BY $sort";
