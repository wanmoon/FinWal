...
$sql = "SELECT MONTH(timestamp) as month, SUM(cost) as income FROM transaction WHERE transaction='Income' AND YEAR(CURDATE()) =YEAR(timestamp) AND cust_id = '$cust_id' GROUP BY month";
